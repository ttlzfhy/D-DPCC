...
def parse_args():
    ...
    parser.add_argument('--ckpt_dir', type=str,
                        default='/home/zhaoxudong/intra/ddpcc_ckpts')
    parser.add_argument('--pcgcv2_ckpt_dir', type=str,
                        default='/home/zhaoxudong/intra/pcgcv2_ckpts')
    parser.add_argument('--frame_count', type=int, default=4, help='number of frames to be coded')
...
if __name__ == '__main__':
    ...
    results = {
        'basketball': {'bpp': [], 'd1-psnr': [], 'd2-psnr': [], 'num_of_bits': [], 'num_of_points': [],
                             'bpip': []},
